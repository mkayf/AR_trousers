            ...
            <div class="modal-body container-fluid">
              <form method="POST" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="mb-3 col-12 col-sm-12 col-md-4 col-lg-4">
                    <label for="product-images" class="form-label">Upload images *</label>
                  ...
                  <div class="mb-3 col-12 col-sm-12 col-md-6 col-lg-6">
                    <label for="product-discounted-price" class="form-label">Product discounted price</label>
                    <input
                      type="number"
                      class="form-control"
                  ...
                  <div class="mb-3 col-4 col-sm-4 col-md-2 col-lg-2">
                    <label for="b-small" class="form-label">Small</label>
                    <input
                      type="number"
                      class="form-control"
                      id="b-small"
                  ...
                  <div class="mb-3 col-4 col-sm-4 col-md-2 col-lg-2">
                    <label for="b-medium" class="form-label">Medium</label>
                    <input
                      type="number"
                      class="form-control"
                      id="b-medium"
                  ...
                  <div class="mb-3 col-4 col-sm-4 col-md-2 col-lg-2">
                    <label for="b-large" class="form-label">Large</label>
                    <input
                      type="number"
                      class="form-control"
                      id="b-large"
                  ...
                  <div class="mb-3 col-4 col-sm-4 col-md-2 col-lg-2">
                    <label for="b-xlarge" class="form-label">X large</label>
                    <input
                      type="number"
                      class="form-control"
                      id="b-xlarge"
                  ...
                  <div class="mb-3 col-4 col-sm-4 col-md-2 col-lg-2">
                    <label for="b-xxlarge" class="form-label">XX large</label>
                    <input
                      type="number"
                      class="form-control"
                      id="b-xxlarge"
                  ...
                  <div class="mb-3 col-4 col-sm-4 col-md-2 col-lg-2">
                    <label for="w-medium" class="form-label">Medium</label>
                    <input
                      type="number"
                      class="form-control"
                      id="w-medium"
                  ...
                  <div class="mb-3 col-4 col-sm-4 col-md-2 col-lg-2">
                    <label for="w-large" class="form-label">Large</label>
                    <input
                      type="number"
                      class="form-control"
                      id="w-large"
                  ...
                  <div class="mb-3 col-4 col-sm-4 col-md-2 col-lg-2">
                    <label for="w-xlarge" class="form-label">X large</label>
                    <input
                      type="number"
                      class="form-control"
                      id="w-xlarge"
                  ...
                  <div class="mb-3 col-4 col-sm-4 col-md-2 col-lg-2">
                    <label for="w-xxlarge" class="form-label">XX large</label>
                    <input
                      type="number"
                      class="form-control"
                      id="w-xxlarge"
                  ...
                  <div class="mb-3 col-6 col-sm-6 col-md-6 col-lg-6">
                    <label for="product-slug" class="form-label">Product slug</label>
                    <input
                      type="text"
                      class="form-control"
                      id="product-slug"
